...
const SignupPage = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      setError('Failed to create account: ' + (error.message || 'Please try again with different information'));
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="mt-4 text-center">
            ...
            <div className="mt-4">
              <Button 
                ...
                disabled={loading}
              >
                <svg width="20" height="20" viewBox="0 0 24 24" className="h-5 w-5 mr-2">
